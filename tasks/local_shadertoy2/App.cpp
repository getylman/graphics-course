  ...
  , useVsync{true}
{
  ...
  etna::create_program(kTextureName, {LOCAL_SHADERTOY2_SHADERS_ROOT "toy.vert.spv", LOCAL_SHADERTOY2_SHADERS_ROOT "texture.frag.spv"});
  etna::create_program(kShaderName, {LOCAL_SHADERTOY2_SHADERS_ROOT "toy.vert.spv", LOCAL_SHADERTOY2_SHADERS_ROOT "toy.frag.spv"});
  ...
  if (nextSwapchainImage)
  {
    ...
    ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
    {
...

      {
        ...
        const auto set = etna::create_descriptor_set(info.getDescriptorLayoutId(0), currentCmdBuf, {etna::Binding{0, bufImage.genBinding(sampler.get(), vk::ImageLayout::eShaderReadOnlyOptimal)}, etna::Binding{1, grafImage.genBinding(sampler.get(), vk::ImageLayout::eShaderReadOnlyOptimal)}});
